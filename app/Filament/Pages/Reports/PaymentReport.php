<?php
/**
 * File: app/Filament/Pages/Reports/PaymentReport.php
 * Purpose: Separate Payment Report menu as you requested - each report is separate menu under Reports group.
 *          Payments by gateway, status, and date with download in CSV/Excel/PDF with header/footer from Report Settings.
...
class PaymentReport extends Page implements HasTable, HasForms
{
    ...
    public function export(string $format)
    {
        ...
        $headerTitle = Setting::get('reports.header_title', config('app.name', 'Travel Company') . ' - Payment Report');
