<?php
/**
 * File: app/Filament/Pages/Reports/DestinationReport.php
 * Purpose: Separate Destination Report menu as you requested - each report is separate menu under Reports group.
 *          Bookings and revenue by destination and region with download in CSV/Excel/PDF with header/footer from Report Settings.
...
class DestinationReport extends Page implements HasTable, HasForms
{
    ...
    protected static ?string $navigationLabel = 'Destination Report';
    protected static ?string $title = 'Destination & Region Report';

    protected string $view = 'filament.pages.reports.destination-report';
    ...
    public function export(string $format)
    {
        ...
        $headerTitle = Setting::get('reports.header_title', config('app.name', 'Travel Company') . ' - Destination Report');
