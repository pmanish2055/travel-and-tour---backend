<?php
/**
 * File: app/Filament/Pages/Reports/PackageReport.php
 * Purpose: Separate Package Report menu as you requested - each report is separate menu under Reports group.
 *          Most booked and most viewed packages with download in CSV/Excel/PDF with header/footer from Report Settings.
...
class PackageReport extends Page implements HasTable, HasForms
{
    ...
    protected static ?string $navigationLabel = 'Package Report';
    protected static ?string $title = 'Package Performance Report';

    protected string $view = 'filament.pages.reports.package-report';
    ...
    public function export(string $format)
    {
        ...
        $headerTitle = Setting::get('reports.header_title', config('app.name', 'Travel Company') . ' - Package Report');
