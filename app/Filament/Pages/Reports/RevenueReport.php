<?php
/**
 * File: app/Filament/Pages/Reports/RevenueReport.php
 * Purpose: Separate Revenue Report menu as you requested - each report is separate menu under Reports group.
 *          Revenue by gateway and monthly, with header/footer from Report Settings with download in CSV/Excel/PDF with header/footer from Report Settings.
...
class RevenueReport extends Page implements HasTable, HasForms
{
    ...
    public function export(string $format)
    {
        ...
        $headerTitle = Setting::get('reports.header_title', config('app.name', 'Travel Company') . ' - Revenue Report');
