<?php
/**
 * File: app/Filament/Pages/Reports/BookingReport.php
 * Purpose: Separate Booking Report menu as you requested - each report is separate menu under Reports group.
 *          Shows bookings with filters (date, package, status) and download in CSV/Excel/PDF with header/footer from Report Settings.
...
class BookingReport extends Page implements HasTable, HasForms
{
...
protected static ?string $title = 'Booking Report - Separate Menu';



    protected string $view = 'filament.pages.reports.booking-report';
    ...
    public function export(string $format)
    {
        ...
        $headerTitle = Setting::get('reports.header_title', config('app.name', 'Travel Company') . ' - Booking Report');
