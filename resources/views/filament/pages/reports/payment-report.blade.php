{{--
  File: resources/views/filament/pages/reports/payment-report.blade.php
  Purpose: View for payment-report report — separate menu under Reports group as you requested.
