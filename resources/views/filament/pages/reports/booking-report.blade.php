{{--
  File: resources/views/filament/pages/reports/booking-report.blade.php
  Purpose: View for booking-report report — separate menu under Reports group as you requested.
