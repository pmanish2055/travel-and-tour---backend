{{--
  File: resources/views/filament/pages/reports/package-report.blade.php
  Purpose: View for package-report report — separate menu under Reports group as you requested.
