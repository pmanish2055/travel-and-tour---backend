{{--
  File: resources/views/filament/pages/reports/revenue-report.blade.php
  Purpose: View for revenue-report report — separate menu under Reports group as you requested.
