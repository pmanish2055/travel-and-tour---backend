{{--
  File: resources/views/filament/pages/reports/destination-report.blade.php
  Purpose: View for destination-report report — separate menu under Reports group as you requested.
